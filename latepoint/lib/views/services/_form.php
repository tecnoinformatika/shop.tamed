  ...
  <form action="" data-os-success-action="redirect" data-os-redirect-to="<?php echo OsRouterHelper::build_link(OsRouterHelper::build_route_name('services', 'index')); ?>" data-os-action="<?php echo $service->is_new_record() ? OsRouterHelper::build_route_name('services', 'create') : OsRouterHelper::build_route_name('services', 'update'); ?>">
    ...
    <div class="white-box">
      ...
      <div class="white-box-content">
        <div class="os-row">
          ...
          <div class="os-col-lg-6">
            <?php echo OsFormHelper::textarea_field('service[short_description]', __('Short Description', 'latepoint'), $service->short_description, array('rows' => 5)); ?>
    ...
    <div class="os-row">
      <div class="os-col-lg-6">
        <div class="white-box">
          <div class="white-box-header">
            <div class="os-form-sub-header"><h3><?php _e('Pricing', 'latepoint'); ?></h3></div>
          </div>
          <div class="white-box-content">
            <div class="os-row">
              <div class="os-col-6">
      ...
      <div class="os-col-lg-6">
        <div class="white-box">
          <div class="white-box-header">
            <div class="os-form-sub-header"><h3><?php _e('Duration', 'latepoint'); ?></h3></div>
          </div>
          <div class="white-box-content">
            <?php echo OsFormHelper::text_field('service[duration]', __('Service Duration', 'latepoint'), $service->duration); ?>
            <div class="os-row">
              <div class="os-col-6">
    ...
    <div class="white-box">
      <div class="white-box-header">
        <div class="os-form-sub-header"><h3><?php _e('Agents', 'latepoint'); ?></h3></div>
      </div>
      <div class="white-box-content">
    ...
    <?php if(!$service->is_new_record()){ ?>
        ...
        <div class="white-box">
          ...
          <div class="white-box-content">
            <div class="latepoint-message latepoint-message-subtle"><?php _e('Agent shares custom daily schedules that you set in general settings for your company, however you can add additional days with custom hours which will be specific to this service only.', 'latepoint'); ?></div>
        ...
        <div class="white-box">
          ...
          <div class="white-box-content">
            <div class="latepoint-message latepoint-message-subtle"><?php _e('Agent uses the same holidays you set in general settings for your company, however you can add additional holidays for this service here.', 'latepoint'); ?></div>
