...
class OsServiceCategoryModel extends OsModel{
  ...
  protected function get_active_services(){
    if(!isset($this->services)){
      $services = new OsServiceModel();
      $this->services = $services->should_be_active()->where(array('category_id'=> $this->id))->order_by('order_number asc')->get_results_as_models();
    }
