...
! defined( 'WOOSB_VERSION' ) && define( 'WOOSB_VERSION', '3.6.1' );
		...
		if ( ! class_exists( 'WPcleverWoosb' ) ) {
			class WPcleverWoosb {
				function __construct() {
					...
					add_filter( 'woocommerce_cart_get_subtotal', array( $this, 'woosb_cart_get_subtotal' ), 99, 1 );
					add_filter( 'woocommerce_calculated_total', array( $this, 'woosb_calculated_total' ), 99, 2 );
                                        ...
                                        <tr class="submit">
                                            <th colspan="2">
                                                ...
                                                <input type="hidden" name="page_options"
                                                       value="_woosb_price_format,_woosb_price_sync,_woosb_price_update,_woosb_bundled_position,_woosb_bundled_thumb,_woosb_bundled_qty,_woosb_bundled_description,_woosb_bundled_price,_woosb_bundled_link,_woosb_change_image,_woosb_change_price,_woosb_cart_contents_count,_woosb_hide_bundle_name,_woosb_hide_bundled,_woosb_hide_bundled_mini_cart,_woosb_bundle_price_text,_woosb_bundle_saved_text,_woosb_archive_button_add,_woosb_archive_button_select,_woosb_archive_button_read,_woosb_single_button_add,_woosb_search_limit,_woosb_search_sku,_woosb_search_exact,_woosb_search_sentence,_woosb_search_same"/>
                                            </th>
                                        </tr>
                                    </table>
                                </form>
                        ...
                        <table>
                            ...
                            <tr class="woosb_tr_space woosb_tr_show_if_auto_price">
                                ...
                                <td style="vertical-align: middle; line-height: 30px;">
                                    ...
                                    . <?php esc_html_e( 'If you fill both percentage and amount, the amount will be used.', 'woo-product-bundle' ); ?>
                                </td>
                            </tr>
                            <tr class="woosb_tr_space">
				...
				function woosb_show_items() {
					...
					if ( $woosb_items = $product->get_items() ) {
						...
						?>
                        <div class="woosb_products woosb-table woosb-products"
				...
				function woosb_show_bundles( $product ) {
					if ( ! $product->is_type( 'woosb' ) ) {
						$product_id       = $product->get_id();
						$product_id_str   = $product_id . '/';
						$woosb_query_args = array(
