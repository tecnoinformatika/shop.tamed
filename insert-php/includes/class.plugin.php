...
if ( ! class_exists( 'WINP_Plugin' ) ) {
	...
	class WINP_Plugin extends Wbcr_Factory413_Plugin {
		...
		private function register_types() {
			$this->registerType( 'WINP_SnippetsType', WINP_PLUGIN_DIR . '/admin/types/snippets-post-types.php' );

			require_once( WINP_PLUGIN_DIR . '/admin/types/snippets-taxonomy.php' );
			Wbcr_FactoryTaxonomies326::register( 'WINP_SnippetsTaxonomy', $this );
		}
		...
		private function load_global() {
			...
			add_action( 'plugins_loaded', function () {
				$safe_mode = isset( $_GET['wbcr-php-snippets-safe-mode'] );
