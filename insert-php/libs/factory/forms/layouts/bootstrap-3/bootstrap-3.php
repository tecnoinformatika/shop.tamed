<?php
	...
	if( !class_exists('Wbcr_FactoryForms413_Bootstrap3FormLayout') ) {
		/**
		 * A form layout based on Twitter Bootstrap 3
		 */
		class Wbcr_FactoryForms413_Bootstrap3FormLayout extends Wbcr_FactoryForms413_FormLayout {
			...
			/**
			 * @param Wbcr_FactoryForms413_Control $control
			 */
