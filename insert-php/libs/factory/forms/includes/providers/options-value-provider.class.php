<?php
	...
	if( !class_exists('Wbcr_FactoryForms413_OptionsValueProvider') ) {
		 ...
		 * @since 1.0.0
		 */
		class Wbcr_FactoryForms413_OptionsValueProvider implements Wbcr_IFactoryForms413_ValueProvider {
