<?php
	...
	if( !class_exists('Wbcr_FactoryForms413_Control') ) {
		 ...
		 * @since 1.0.0
		 */
		abstract class Wbcr_FactoryForms413_Control extends Wbcr_FactoryForms413_FormElement {
			 ...
			 *
			 * @param mixed[] $options
			 * @param FactoryForms413_Form $form
			 * @param null $provider
			 * @since 1.0.0
			 * @return void
			 */
			 ...
			 *
			 * @since 1.0.0
			 * @param IFactoryForms413_ValueProvider $provider
			 * @return void
			 */
