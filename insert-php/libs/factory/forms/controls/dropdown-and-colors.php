<?php
	 ...
	 *  // see FactoryForms413_DropdownControl
	 * 'dropdown' => array(
	 ...
	 *    ),
	 * // see FactoryForms413_RadioColorsControl
	 * 'colors' => array(
	 *   // a callback to return items or an array of items to select
	 *   'data' => array(
	...
	if( !class_exists('Wbcr_FactoryForms413_DropdownAndColorsControl') ) {
		
		class Wbcr_FactoryForms413_DropdownAndColorsControl extends Wbcr_FactoryForms413_ComplexControl {
			...
			public function __construct($options, $form, $provider = null)
			{
				...
				$this->dropdown = new Wbcr_FactoryForms413_DropdownControl($options['dropdown'], $form, $provider);
				$this->colors = new Wbcr_FactoryForms413_RadioColorsControl($options['colors'], $form, $provider);
