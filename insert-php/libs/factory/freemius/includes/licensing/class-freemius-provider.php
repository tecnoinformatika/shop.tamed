...
namespace WBCR\Factory_Freemius_102\Premium;

use WBCR\Factory_Freemius_102\Entities\License;
use WBCR\Factory_Freemius_102\Entities\Plugin;
use WBCR\Factory_Freemius_102\Entities\Site;
use WBCR\Factory_Freemius_102\Entities\User;
use WBCR\Factory_413\Premium\Provider as License_Provider;
use Wbcr_Factory413_Plugin;
use WBCR\Factory_Freemius_102\Api;
use WP_Error;
use Exception;
use stdClass;
...
final class Provider extends License_Provider {
	...
	/**
	 * @var \WBCR\Factory_Freemius_102\Api
	 */
	private $site_api;
	 ...
	 * @throws Exception
	 */
	public function __construct( Wbcr_Factory413_Plugin $plugin, array $settings ) {
	...
	/**
	 * @return \WBCR\Factory_Freemius_102\Entities\License|null
	 * @throws Exception
	 */
	 ...
	 * @param bool $flush
	 *
	 * @return \WBCR\Factory_Freemius_102\Api
	 * @throws Exception
	 */
