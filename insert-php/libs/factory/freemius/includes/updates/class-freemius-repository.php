...
namespace WBCR\Factory_Freemius_102\Updates;

// Exit if accessed directly
use Exception;
use Wbcr_Factory413_Plugin;
use WBCR\Factory_413\Updates\Repository;
...
class Freemius_Repository extends Repository {
	...
	/**
	 * @var \WBCR\Factory_Freemius_102\Premium\Provider
	 */
	private $premium;
	...
	public function init() {
		if ( ! $this->premium instanceof \WBCR\Factory_Freemius_102\Premium\Provider ) {
