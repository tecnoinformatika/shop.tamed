<?php
	...
	add_action('admin_menu', 'Wbcr_FactoryPages413::actionAdminMenu');
	add_action('network_admin_menu', 'Wbcr_FactoryPages413::actionAdminMenu');
	...
	if( !class_exists('Wbcr_FactoryPages413') ) {
		 ...
		 * @since 1.0.0
		 */
		class Wbcr_FactoryPages413 {

			/**
			 * @var Wbcr_FactoryPages413_Page[]
			 */
			...
			public static function getPageUrl(Wbcr_Factory413_Plugin $plugin, $page_id, $args = array())
			{
				if( isset(self::$pages[$plugin->getPluginName()]) ) {
	...
	if( !function_exists('wbcr_factory_pages_413_get_page_id') ) {
		/**
		 *
		 * @param Wbcr_Factory413_Plugin $plugin
		 ...
		 * @return string
		 */
		function wbcr_factory_pages_413_get_page_id($plugin, $page_id)
		{
