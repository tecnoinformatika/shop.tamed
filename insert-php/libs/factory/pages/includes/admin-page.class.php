...
if ( ! class_exists( 'Wbcr_FactoryPages413_AdminPage' ) ) {
	
	class Wbcr_FactoryPages413_AdminPage extends Wbcr_FactoryPages413_Page {
		...
		public function connect() {
			...
			$this->hidden = apply_filters( 'wbcr_factory_413_page_is_hidden_' . $result_id, $this->hidden );
			
			if ( $this->hidden ) {
				return;
			}
			
			$this->internal = apply_filters( 'wbcr_factory_413_page_is_internal_' . $result_id, $this->internal );
