...
namespace WBCR\Factory_413\Premium;
...
class Manager {
	 ...
	 * @param array $settings
	 *
	 * @return \WBCR\Factory_Freemius_102\Premium\Provider
	 * @throws Exception
	 */
	public static function instance( Wbcr_Factory413_Plugin $plugin, array $settings ) {
	...
	public function instance_provider() {
		...
		if ( 'freemius' == $provider_name ) {
			return new \WBCR\Factory_Freemius_102\Premium\Provider( $this->plugin, $this->settings );
