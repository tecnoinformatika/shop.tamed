 ...
 * @since 4.0.8
 */
class  Wbcr_Factory413_Base {
	
	use WBCR\Factory_413\Options;
	...
	/**
	 * @var \WBCR\Factory_413\Entities\Support
	 */
	protected $support;
	
	/**
	 * @var \WBCR\Factory_413\Entities\Paths
	 */
	protected $paths;
	...
	public function __construct( $plugin_file, $data ) {
		...
		$this->support = new \WBCR\Factory_413\Entities\Support( $this->support_details );
		$this->paths   = new \WBCR\Factory_413\Entities\Paths( $plugin_file );
	...
	/**
	 * @return \WBCR\Factory_413\Entities\Support
	 */
	...
	/**
	 * @return \WBCR\Factory_413\Entities\Paths
	 */
