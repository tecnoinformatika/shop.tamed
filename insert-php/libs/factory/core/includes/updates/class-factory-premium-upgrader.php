...
use Wbcr_FactoryPages413_ImpressiveThemplate;
...
class Premium_Upgrader extends Upgrader {
	 ...
	 *
	 * @param Wbcr_Factory413_Plugin $plugin
	 * @param Wbcr_FactoryPages413_ImpressiveThemplate $obj
	 *
	 * @return void
	 * @since 4.1.1
	 *
	...
	private function get_notice_text( $type ) {
		...
		$texts = array(
			'need_activate_license'   => __( 'License activation required. A license is required to get premium plugin updates, as well as to get additional services.', 'wbcr_factory_413' ),
			'need_renew_license'      => __( 'Your license has expired. You can no longer get premium plugin updates, premium support and your access to Webcraftic services has been suspended.', 'wbcr_factory_413' ),
        ...
        <a href="%s">Install</a> premium add-on or <a href="%s">cancel</a> license.', 'wbcr_factory_413' ), $upgrade_url, $cancel_license_url ),
        ...
        <a href="%s">Activate</a> premium add-on or <a href="%s">cancel</a> license.', 'wbcr_factory_413' ), $activate_plugin_url, $cancel_license_url )
		);
