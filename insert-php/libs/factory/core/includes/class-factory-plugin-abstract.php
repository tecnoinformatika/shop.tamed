 ...
 *
 */
abstract class Wbcr_Factory413_Plugin extends Wbcr_Factory413_Base {

	/**
	 * Instance class Wbcr_Factory413_Request, required manages http requests
	 *
	 * @var Wbcr_Factory413_Request
	 */
	public $request;
	 ...
	 *
	 * @var Wbcr_FactoryBootstrap413_Manager
	 */
	public $bootstrap;
	 ...
	 * The Bootstrap Manager class
	 *
	 * @var Wbcr_FactoryForms413_Manager
	 */
	public $forms;
	 ...
	 *
	 * @var array[] Wbcr_Factory413_Plugin
	 */
	...
	public function __construct( $plugin_path, $data ) {
		...
		$this->request = new Wbcr_Factory413_Request();
		//$this->route = new Wbcr_Factory413_Route();
	...
	/**
	 * @param Wbcr_FactoryBootstrap413_Manager $bootstrap
	 */
	public function setBootstap( Wbcr_FactoryBootstrap413_Manager $bootstrap ) {
		$this->bootstrap = $bootstrap;
	}

	/**
	 * @param Wbcr_FactoryForms413_Manager $forms
	 */
	public function setForms( Wbcr_FactoryForms413_Manager $forms ) {
		$this->forms = $forms;
	}
	...
	public function registerPage( $class_name, $file_path ) {
		...
		if ( ! class_exists( 'Wbcr_FactoryPages413' ) ) {
			throw new Exception( 'The factory_pages_413 module is not included.' );
		}

		Wbcr_FactoryPages413::register( $this, $class_name );
	}
	...
	public function registerType( $class_name, $file_path ) {
		...
		if ( ! class_exists( 'Wbcr_FactoryTypes406' ) ) {
			throw new Exception( 'The factory_types_406 module is not included.' );
		}

		Wbcr_FactoryTypes406::register( $class_name, $this );
	}
	...
	public function activation_hook() {
		 ...
		 */
		if ( apply_filters( "wbcr/factory_413/cancel_plugin_activation_{$this->plugin_name}", false ) ) {
			return;
		}

		/**
		 * wbcr_factory_413_plugin_activation
		 *
		 * @since 4.1.1 - deprecated
		 */
		wbcr_factory_413_do_action_deprecated( 'wbcr_factory_413_plugin_activation', [
			$this
		 ...
		 */
		wbcr_factory_413_do_action_deprecated( 'wbcr/factory/plugin_activation', [
			$this
		 ...
		 * @since 4.1.2 - deprecated
		 */
		wbcr_factory_413_do_action_deprecated( "wbcr/factory/plugin_{$this->plugin_name}_activation", [
			$this
		], '4.1.2', "wbcr/factory/before_plugin_{$this->plugin_name}_activation" );

		/**
		 * wbcr_factory_413_plugin_activation_' . $this->plugin_name
		 *
		 * @since 4.1.1 - deprecated
		 */
		wbcr_factory_413_do_action_deprecated( 'wbcr_factory_413_plugin_activation_' . $this->plugin_name, [
			$this
	...
	public function deactivation_hook() {
		 ...
		 * @since 4.1.1 - change  hook name
		 */
		if ( apply_filters( "wbcr/factory_413/cancel_plugin_deactivation_{$this->plugin_name}", false ) ) {
			return;
		}

		/**
		 * wbcr_factory_413_plugin_deactivation
		 *
		 * @since 4.1.1 - deprecated
		 */
		wbcr_factory_413_do_action_deprecated( 'wbcr_factory_413_plugin_deactivation', [
			$this
		 ...
		 * @since 4.1.2 - deprecated
		 */
		wbcr_factory_413_do_action_deprecated( 'wbcr/factory/plugin_deactivation', [
			$this
		...
		/**
		 * wbcr_factory_413_plugin_deactivation_ . $this->plugin_name
		 *
		 * @since 4.1.1 - deprecated
		 */
		wbcr_factory_413_do_action_deprecated( 'wbcr_factory_413_plugin_deactivation_' . $this->plugin_name, [
			$this
		 ...
		 * @since 4.1.2 - deprecated
		 */
		wbcr_factory_413_do_action_deprecated( "wbcr/factory/plugin_{$this->plugin_name}_deactivation", [
			$this
	...
	public function getPluginPageUrl( $page_id, $args = [] ) {
		...
		return Wbcr_FactoryPages413::getPageUrl( $this, $page_id, $args );
	}
	...
	private function init_framework_modules() {
		 ...
		 * @since 4.1.1 - deprecated
		 */
		wbcr_factory_413_do_action_deprecated( 'wbcr_factory_413_core_modules_loaded-' . $this->plugin_name, [], '4.1.1', "wbcr/factory_413/modules_loaded-" . $this->plugin_name );

		/**
		 * @since 4.1.1 - add
		 */
		do_action( 'wbcr/factory_413/modules_loaded-' . $this->plugin_name );
	}
	...
	private function register_plugin_hooks() {
		...
		if ( is_admin() ) {
			add_filter( 'wbcr_factory_413_core_admin_allow_multisite', '__return_true' );
	...
	protected function init_plugin_migrations() {
		new WBCR\Factory_413\Migrations( $this );
	}
	...
	protected function init_plugin_notices() {
		new Wbcr\Factory_413\Notices( $this );
	}
	...
	protected function init_plugin_updates() {
		if ( $this->has_updates ) {
			new WBCR\Factory_413\Updates\Upgrader( $this );
		}
	}
	...
	protected function init_plugin_premium_features() {
		...
		$this->premium = WBCR\Factory_413\Premium\Manager::instance( $this, $this->license_settings );

		// Подключаем премиум апгрейдер
		if ( isset( $this->license_settings['has_updates'] ) && $this->license_settings['has_updates'] ) {
			new WBCR\Factory_413\Updates\Premium_Upgrader( $this );
		}
	}
	...
	public function newScriptList() {
		return new Wbcr_Factory413_ScriptList( $this );
	}

	public function newStyleList() {
		return new Wbcr_Factory413_StyleList( $this );
	}
}
