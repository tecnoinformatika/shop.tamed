...
if ( ! class_exists( 'Wbcr_FactoryTypes406' ) ) {
	...
	add_action( 'wbcr/factory/before_plugin_activation', 'Wbcr_FactoryTypes406::activationHook' );
	add_action( 'wbcr/factory/before_plugin_deactivation', 'Wbcr_FactoryTypes406::deactivationHook' );
	...
	class Wbcr_FactoryTypes406 {
		 ...
		 */
		public static function register( $class_name, Wbcr_Factory413_Plugin $plugin = null ) {
		 ...
		 * @return void
		 */
		public static function deactivationHook( Wbcr_Factory413_Plugin $plugin ) {
