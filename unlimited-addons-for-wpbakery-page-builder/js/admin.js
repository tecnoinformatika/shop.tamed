...
function UniteAdminUC(){
	...
	/**
	 * convert params to relative url's
	 */
	this.paramsToUrlRelative = function(params){
		...
		jQuery.each(params, function(index, param){
			...
			if(param === g_urlBaseUC)
				return(true);
			
			var pos = param.indexOf(g_urlBaseUC);
			if(pos !== 0)
				return(true);
			
			param = t.urlToRelative(param);
