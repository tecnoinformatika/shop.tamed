function UniteCreatorAddonDefaultsAdmin(){
	...
	function initEvents(){
		...
		jQuery("#uc_addondefaults_button_save").click(onSaveDataClick);
		
		jQuery("#uc_addondefaults_button_delete").click(onDeleteDataClick);

		jQuery("#uc_addondefaults_button_restore").click(onRestoreDataClick);
	
		jQuery("#uc_addondefaults_button_clear").click(g_objConfig.clearData);
